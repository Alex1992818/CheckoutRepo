...
class VendorsFirebaseRepository implements VendorsRepositoryInterface
{
    ...
    public function getVendorMenuItems($searchkey)
    {
        // TODO: Implement getVendorProducts() method.
        $products = [];
        $collection = $this->database->collection('vendor_products');
        
        $query = $collection->where('item_name', '=',$searchkey);
...
//        }
    ...
    public function registerRestaurant($data) {
        ...
        $collection = $this->database->collection('leads');
        ...
        return json_encode($restaurant, false);
    }
}
